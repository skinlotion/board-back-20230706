...
public class BoardListItem {
    ...
    public BoardListItem(BoardViewEntity boardViewEntity) {
        ...
        this.favoritrCount = boardViewEntity.getFavoriteCount();
        this.commentCount = boardViewEntity.getCommentCount();
        this.writeDatetime = boardViewEntity.getWriteDatetime();
        this.writeEmail = boardViewEntity.getWriterEmail();
        this.writeNickname = boardViewEntity.getWriterNickname();
        this.writeProfileImage = boardViewEntity.getWriterProfileImage();
    }
