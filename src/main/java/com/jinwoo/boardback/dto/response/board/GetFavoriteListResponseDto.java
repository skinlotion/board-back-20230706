...
import com.jinwoo.boardback.common.object.FavoriteListItem;
...
public class GetFavoriteListResponseDto extends ResponseDto{
    ...
    public static ResponseEntity<GetFavoriteListResponseDto> success(List<UserEntity> userEntities) {
        GetFavoriteListResponseDto result = new GetFavoriteListResponseDto(ResponseCode.SUCCES, ResponseMessage.SUCCES, userEntities);
